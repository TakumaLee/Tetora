...
// Translations maps language codes to their InitStrings.
var Translations = map[string]InitStrings{
	"en": {
		...
		RolePermPrompt:        "Permission mode (plan|acceptEdits|auto|bypassPermissions)",
	...
	"zh-TW": {
		...
		RoleDescPrompt:        "描述",
		RolePermPrompt:        "權限模式 (plan|acceptEdits|auto|bypassPermissions)",
	...
	"ja": {
		...
		RoleDescPrompt:        "説明",
		RolePermPrompt:        "権限モード (plan|acceptEdits|auto|bypassPermissions)",
	...
	"ko": {
		...
		RoleDescPrompt:        "설명",
		RolePermPrompt:        "권한 모드 (plan|acceptEdits|auto|bypassPermissions)",
	...
	"de": {
		...
		RolePermPrompt:        "Berechtigungsmodus (plan|acceptEdits|auto|bypassPermissions)",
	...
	"es": {
		...
		RolePermPrompt:        "Modo de permiso (plan|acceptEdits|auto|bypassPermissions)",
	...
	"fr": {
		...
		RoleDescPrompt:        "Description",
		RolePermPrompt:        "Mode de permission (plan|acceptEdits|auto|bypassPermissions)",
	...
	"id": {
		...
		RolePermPrompt:        "Mode izin (plan|acceptEdits|auto|bypassPermissions)",
	...
	"th": {
		...
		RolePermPrompt:        "โหมดสิทธิ์ (plan|acceptEdits|auto|bypassPermissions)",
...
// GetInitStrings returns the InitStrings for the given language code,
// falling back to English if the code is not found.
func GetInitStrings(lang string) InitStrings {
